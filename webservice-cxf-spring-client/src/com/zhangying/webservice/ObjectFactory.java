 ...
 * generated in the com.zhangying.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://webservice.zhangying.com", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://webservice.zhangying.com", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zhangying.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.zhangying.com", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.zhangying.com", name = "queryWeatherResponse")
