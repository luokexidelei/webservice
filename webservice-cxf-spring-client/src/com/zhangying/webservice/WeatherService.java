 ...
 * 
 */
@WebServiceClient(name = "WeatherService", targetNamespace = "http://webservice.zhangying.com", wsdlLocation = "http://localhost:8080/webservice-cxf-spring/ws/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICE_QNAME = new QName("http://webservice.zhangying.com", "WeatherService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webservice-cxf-spring/ws/weather?wsdl");
    ...
    public WeatherInterface getWeatherServiceSoap() {
        return super.getPort(new QName("http://webservice.zhangying.com", "WeatherServiceSoap"), WeatherInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "WeatherServiceSoap")
    public WeatherInterface getWeatherServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.zhangying.com", "WeatherServiceSoap"), WeatherInterface.class, features);
    }
