        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <!-- 
                    list 数据来源
                    listKey option中value的值
                    listValue 显示的文本内容
                     -->
                    
                        <td><s:select list="#departments" listKey="did" listValue="dname" headerKey="" headerValue="请选择部门" name="did"
                    ...
                    <tr><td>用户名</td>
                        ...
                        <td><s:textfield name="username" cssClass="InputStyle"></s:textfield><s:label id="msg"></s:label>
						</td>
                    </tr>
					<tr><td>性别</td>
					
                        <td><s:radio name="sex" list="{'男','女'}"></s:radio>
						</td>
                    </tr>
					<tr><td>联系电话</td>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
						<td width="100">岗位</td>
                        <td><s:select list="#posts" name="pids" listKey="pid" listValue="pname" 
                    cssClass="SelectStyle" multiple="true" size="10"
                    ></s:select>
                            按住Ctrl键可以多选或取消选择
                        </td>
                    </tr>
